...
levelInfos = [5, "Niveau 5", textFile.readData("completed", 1, "./Game/levelsData.json"), 6, textFile.readData("score", 1, "./Game/levelsData.json"), 30, 0]
...
def levelFunction():
    ...
    while gameLoop:
        ...
        for carSpawnPoint in carSpawnPointsList:
            carFile.createCars(carSpawnPoint, spritesList, carList, windowWidth, windowHeight, ticks, (3, 5)) # Create the cars
