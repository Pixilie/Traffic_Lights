...
levelInfos = [5, "Niveau 5", textFile.readData("completed", 5, "./Game/levelsData.json"), 8, textFile.readData("score", 5, "./Game/levelsData.json"), 60, 0]
...
def levelFunction():
    ...
    while gameLoop:
        ...
        for carSpawnPoint in carSpawnPointsList:
            carFile.createCars(carSpawnPoint, spritesList, carList, windowWidth, windowHeight, ticks, (3, 5))
