...
def levelFunction():
    ...
    while gameLoop:
        ...
        textFile.writeText(windowWidth*0.002, 0, "Arial", 22, (0, 0, 0), f"Vie(s): {lives}", False, window)
        textFile.writeText(windowWidth*0.002, windowHeight*0.03, "Arial", 22, (0, 0, 0), f"Score: {score}", False, window)
