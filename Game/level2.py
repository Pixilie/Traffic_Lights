...
levelInfos = [2, "Niveau 2", textFile.readData("completed", 1, "./Game/levelsData.json"), 3, textFile.readData("score", 1, "./Game/levelsData.json"), 10, 0]
...
def levelFunction():
    ...
    # Sprites list
    spritesList, roadList, trafficLightsList, carSpawnPointsList, grassList = map.loadMap("./Game/Assets/Maps/map_lvl2.txt", window)
    ...
    while gameLoop:
        ...
        for carSpawnPoint in carSpawnPointsList:
            carFile.createCars(carSpawnPoint, spritesList, carList, windowWidth, windowHeight, ticks, (1, 3)) # Create the cars
